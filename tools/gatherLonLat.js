...
var planeMeshHeight = require('../src/planeMeshHeight.js');
var CUB = require('../front/src/CUB_parameters.js');
var GeoConverter = require('../front/src/geoConverter.js');
...
function extractBuildings(_3dsPath, x, y){
    ...
    parse3ds(_3dsPath, function(err, data){
        ...
        */
        ...
        /*
            Working around https://github.com/anthill/bordeaux3d/issues/26
        */
